    ...
    <div class="container">
        ...
        <div class="flex flex-col gap-4 items-center lg:justify-between mb-[var(--blocks-gap-demi)] lg:gap-0 lg:flex-row">
            ...
            <div class="flex items-center">
                <button class="border-white border-solid border-[2px] w-[30px] h-[30px] rounded-full active cursor-pointer active step-circle" on:click={handleClick}></button>
                <div class="bg-white w-[60px] h-[2px]"></div>
                <button class="border-white border-solid border-[2px] w-[30px] h-[30px] rounded-full cursor-pointer step-circle" on:click={handleClick}></button>
                <div class="bg-white w-[60px] h-[2px]"></div>
                <button class="border-white border-solid border-[2px] w-[30px] h-[30px] rounded-full cursor-pointer step-circle" on:click={handleClick}></button>
            </div>
        </div>
        ...
        <form class="shadow-lg bg-white lg:p-24 p-10 rounded-xl">
            ...
            <div id="step_one">
                ...
                <div class="lg:flex lg:justify-between lg:items-center mt-7 lg:mt-0">
                    ...
                    <button class="mt-7 font-finalSixMedium bg-green text-white rounded-lg py-3 px-8">Continuer</button>
                </div>
            ...
            <div id="step_two">
                ...
                <div class="lg:flex lg:justify-between lg:items-center mt-7 lg:mt-0">
                    <div>
                        ...
                        <label class="font-finalSixLight italic" for="cgv">En envoyant ce formulaire, j’accepte que la team Green Skills me recontacte.</label>
                    </div>
                    <button class="mt-7 font-finalSixMedium bg-green text-white rounded-lg py-3 px-8">Valider le formulaire</button>
                </div>
            </div>
